...
void OpenSocket(struct sockaddr_in servaddr) {
...
void SendData(struct sockaddr_in cliaddr, char* file) {
...
int main() {
    ...
    struct sockaddr_in cliaddr = InitializeClientAddr();
      
    OpenSocket(servaddr);

    SendData(cliaddr, "/Users/nikolaystanishev/Workspace/personal/tu/VI/system-programming/tu-system-programming/2021-05-18/test.mp3");
